...
class ClaimController extends Controller
{
    ...
    {
        $claimModel = $this->scopedQuery()->find($claim);
    ...
    /**
     * Admin sees every claim in the school — unlike Director\ClaimController, there's no
     * director_id (or career) restriction here.
     */
